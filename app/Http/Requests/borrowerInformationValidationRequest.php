...
class borrowerInformationValidationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "parent1_fname" => 'required|string|max:100',
            "parent1_lname" => 'required|string|max:100',
            ...
            "parent2_fname" => 'nullable|string|max:100',
            "parent2_lname" => 'nullable|string|max:100',
    ...
    public function messages()
    {
        return [
            ...
            'fname.required' => 'ต้องกรอกชื่อจริง',
            'fname.max' => 'ชื่อจริงต้องมีครวามยาวไม่เกิน 50 ตัวอักษร',
            'lname.required' => 'ต้องกรอกนามสกุล',
            'lname.max' => 'นามสกุลต้องมีครวามยาวไม่เกิน 50 ตัวอักษร',
            ...
            "phone_number.required" => 'ต้องระบุเบอร์โทร',
            "phone_number.max" => 'เบอร์โทรศัพท์ต้องมีครวามยาวไม่เกิน 50 ตัวอักษร',

            "props.required" => 'ต้องระบุคุณสมบัตรผู้กู้',
            "necess.required" => 'ต้องระบุเหตุผลตวามจำเป็นในการกู้ยืม',
            ...
            'parent1_fname.required' => 'ต้องกรอกชื่อจริงผู้ปกครอง',
            'parent1_fname.max' => 'ชื่อจริงผู้ปกครองต้องมีครวามยาวไม่เกิน 50 ตัวอักษร',
            'parent1_lname.required' => 'ต้องกรอกนามสกุลผู้ปกครอง',
            'parent1_lname.max' => 'นามสกุลผู้ปกครองต้องมีครวามยาวไม่เกิน 50 ตัวอักษร',
            ...
            "parent2_fname.max" => 'ชื่อจริงผู้ปกครองต้องมีครวามยาวไม่เกิน 50 ตัวอักษร',
            "parent2_lname.max" => 'นามสกุลผู้ปกครองต้องมีครวามยาวไม่เกิน 50 ตัวอักษร',
