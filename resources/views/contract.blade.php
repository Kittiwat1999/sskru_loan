...
@section('content')
        ...
        <div class="card">
            <div class="card-body pt-3">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <button class="nav-link active" id="contract-submission-tab" data-bs-toggle="tab" data-bs-target="#contract-submission" type="button" role="tab" aria-controls="contract-submission" aria-selected="true">รายการสัญญา</button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content pt-2" id="myTabContent">
                  <!-- รายการยื่นกู้ -->
                  <div class="tab-pane fade show active" id="contract-submission" role="tabpanel" aria-labelledby="contract-submission-tab">
                    <div class="row">
                        <div class="col-md-4">
                  ...
                  <div class="card-body">
                    <fieldset class="row mb-3 mt-3">
                      ...
                      <div class="col-sm-10">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="contract_confirm" id="contract_confirm_radio" value="true" checked onchange="enableCheckbox('contract_')">
                          <label class="form-check-label" for="contract_confirm_radio">
                            เอกสารถูกต้อง
                          </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="contract_confirm" id="contract_to_edit" value="false" onchange="enableCheckbox('contract_')">
                          <label class="form-check-label" for="contract_to_edit">
                            เอกสารไม่ถูกต้อง
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="row mb-3 mt-2 text-dark text-start">
                      ...
                      <div class="col-sm-5">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="contract_comment_1" disabled>
                          <label class="form-check-label" for="contract_comment_1" name="contract_comment_1">
                            เอกสารไม่ชัดเจน
                          </label>
                        </div>
      
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="contract_comment_2" disabled>
                          <label class="form-check-label" for="contract_comment_2" name="contract_comment_2">
                            บัตรประชาชนหมดอายุ
                          </label>
                        </div>
      
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="contract_more_radio" disabled onchange="enableInputArea('contract_')">
                          <label class="form-check-label" for="contract_more_radio" >
                            อื่นๆ
                          </label>
                        </div>
                        <div class="input-group">
                          <label for="contract_moreText"></label>
                          <textarea class="form-control" name="contract_moreText" id="contract_moreText" cols="30" rows="4" disabled></textarea>
                        </div>
                      </div>
                      <div class="col-sm-5">
      
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="contract_comment_3" disabled>
                          <label class="form-check-label" for="contract_comment_3" name="contract_comment_3">
                            ลายมือชื่อในเอกสารกับสำเนาบัตรไม่ตรงกัน
                          </label>
                        </div>
      
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="contract_comment_4" disabled>
                          <label class="form-check-label" for="contract_comment_4" name="contract_comment_4">
    ...
    <script>
      ...
      function showEditModal(borrowerId){
        fetch(`/contract/to_edit/${borrowerId}`)
        .then(response => {
