...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a id="borrower_index" class="nav-link collapsed" href="{{route('borrower_index')}}">
      ...
      <li class="nav-item">
        <a id="borrower_loan_request" class="nav-link collapsed" href="{{route('borrower_loan_request')}}">
    ...
    <script>
       function activeSidebar(activeElement){
        document.getElementsByTagName('a').className = 'nav-link collapsed';
