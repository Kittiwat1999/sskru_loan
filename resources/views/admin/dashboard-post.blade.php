        ...
        <div class="card-body">
          <h5 class="card-title">ตัวช่วยการค้นหา</h5>
            <form id="dashbord-form" class="row" action="{{route('admin.dashboard.set-data')}}" method="POST">
              ...
              <div class="col-md-4">
                <label for="select_faculty" class="col-form-label text-secondary">คณะ</label>
              ...
              <div class="col-md-4">
                <label for="select_major" class="col-form-label text-secondary">สาขา</label>
...
<script>
  ...
  function getMajorByFacultyId(faculty_id){
    ...
    .then(majors => {
        var select_major_element = document.getElementById('select_major');
        select_major_element.innerHTML = `<option selected disabled value="admin">ทั้งหมด</option>`;
  ...
  function termInput(){
    ...
    const input_year = document.getElementById('select_year');
  ...
  function validateForm(form_id){
    const form = document.getElementById(form_id);
    const input_doctype = form.querySelector('#select_doc_type');
    var validator = true;
