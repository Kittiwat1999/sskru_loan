                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                              ...
                              @else
                              <a href="{{route('search.document.view.document.page',['borrower_document_id' => Crypt::encryptString($borrower_document->id) ])}}" class="btn btn-sm btn-primary">ดูไฟล์ที่ส่ง</a>
                              @endif
                            </td>
