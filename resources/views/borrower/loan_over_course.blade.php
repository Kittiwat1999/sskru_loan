                        ...
                        <div class="col-md-10">
                            <ul class="list-group list-borderless">
                                <li class="list-group-item">
                                    ...
                                    แบบคำร้องขอกู้ยืมเงินกองทุนเงินให้กู้ยืมเพื่อการศึกษา เกินกว่าจำนวนปีที่กำหนดไว้ในหลักสูตร
                                </li>
                            </ul>
                        </div>
                            ...
                            <div id="borrower-document" class="carousel slide my-3 w-100 border" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active" id="yinyorm">
                                        <img src="{{asset('assets/img/doc/ขอกู้ยืมเกินหลักสูตร-1.png')}}" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item" id="samnao">
                                        <img src="{{asset('assets/img/doc/ขอกู้ยืมเกินหลักสูตร-2.png')}}" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="sumary" role="tabpanel" aria-labelledby="sumary-tab">
                    <div class="row">
                        ...
                        <div class="col-sm-12 my-1">
                            <span>เอกสารยื่นกู้เกินหลักสูตร</span>&emsp;
