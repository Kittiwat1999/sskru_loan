            ...
            <div class="card-body">
                ...
                <div class="row my-6 mx-1  border border-2 mb-2">
                    <div class="col-md-12 iframe-container">
                        <iframe id="pdfIframe" src="{{route('borrower.response.document',['child_document_id' => $child_document->id, 'request_type' => 'preview'])}}" frameborder="1" class="w-100" height="800"></iframe>
                    </div>
                </div>    
                <div class="text-end">
