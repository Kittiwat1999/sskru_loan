...
<script>
    ...
    function input_parent3(){
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control for-disabled" id="parent3_postcode" name="parent3_postcode" required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-5 mb-3">
            ...
            <input type="text" class="form-control for-disabled" id="parent3_tambon" name="parent3_tambon" required>
            <div class="invalid-feedback">
                กรุณากรอกตำบล
            </div>
        </div>
