        ...
        <div class="card-body">
            ...
            <form action="{{route('borrower.store.parent.information')}}" id="parent-form" class="row" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="parent1_postcode" name="parent1_postcode" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-5 mb-3">
                    ...
                    <input type="text" class="form-control" id="parent1_tambon" name="parent1_tambon" required>
                    <div class="invalid-feedback">
                        กรุณากรอกตำบล
                    </div>
                </div>
