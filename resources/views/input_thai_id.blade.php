...
<body>
  ...
  <main>
        ...
        <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="card mb-3 col-md-8 pb-4 pt-4">
                        <div class="card-body">
                            <div class="pt-4 pb-2">
                                <h5 class="card-title text-center pb-0 fs-4">ลงทะเบียน</h5>
                                <p class="text-center small">กรุณากรอกหมายเลขบัตรประจำตัวประชาชน</p>
                            </div>

                            <form id="form-thai-id" action="{{route('check_email.reset_password')}}" method="POST">
                                @csrf
                                <div class="row mb-3">
                                    <label for="thai-id" class="col-md-4 col-lg-4 col-form-label">หมายเลขบัตรประจำตัวประชาชน</label>
                                    <div class="col-md-8 col-lg-8">
                                        <input name="thai-id" type="text" class="form-control" id="thai-id" maxlength="13" required>
                                    </div>
                                    <div class="invalid-feedback">กรุณากรอกหมายเลขบัตรประจำตัวประชาชน!</div>
                                </div>
    ...
    <script>
        const formEmail = document.getElementById('form-thai-id');
